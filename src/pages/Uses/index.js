...
const Uses = () => {
  ...
  return (
    <Fragment>
      <Helmet>
        <title>Uses | Bhargav Butani</title>
        <meta
          name="description"
              ...
              <ProjectSectionText>
                <ul>
                  <li>
                    ...
                    UI design these days. Made the portfolio from scratch in 2020 and haven't
                    looked back.
                  </li>
                </ul>
              </ProjectSectionText>
        ...
        <ProjectSection className="uses__section">
          <ProjectSectionContent>
            <ProjectTextRow stretch width="m">
              ...
              <ProjectSectionText>
                A normal budget Dell laptop with intel i5 processor with 8th generation and 2TB HDD + 500GB SSD plus 4GB Intel Graphics + 2 GB Radeon Graphics(Entry level) and lastly windows 11 is current update but i like ubuntu more(Don't tell anyone).
              </ProjectSectionText>
