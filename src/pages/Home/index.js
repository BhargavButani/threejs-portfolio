...
const Home = () => {
  ...
  return (
    <div className="home">
      <Helmet>
        <title>Bhargav Butani | Web Developer</title>
        <meta
          name="description"
          content="Portfolio of Bhargav Butani – a web developer working on web development with a focus on tech and intelligence."
        />
      ...
      <ProjectSummary
        ...
        index={1}
        title="Designing the future of articles and news"
        description="Designing a platform to help authors build better online knowledgable platforms."
