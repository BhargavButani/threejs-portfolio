...
const title = 'Designing the future of articles and news';
const description =
  'I worked as the frontend lead on a major iteration of Portablelib product. We took the platform in a bold new direction, focusing on becoming the best tool for authors and students and learners.';
const roles = [
  'Project management',
  'User research',
        ...
        <ProjectSection first>
          <ProjectSectionContent>
            <ProjectImage
              ...
              alt="The Portablelib web app for authors and students."
            />
          </ProjectSectionContent>
        </ProjectSection>
        <ProjectSection>
          <ProjectTextRow>
            ...
            <ProjectSectionText>
              In 2020, We have discovered people’s problem by researching on their
              intrests and we have found that most of the people visit different places
              for different things. We have found three common things that people wants to
              be found together so there will be no struggle needed to visit different
              places. The three common things are Article, Notes and News should be found
              together. So, we have decided to make things easier for people by making
              this three things together..
            </ProjectSectionText>
          </ProjectTextRow>
        </ProjectSection>
